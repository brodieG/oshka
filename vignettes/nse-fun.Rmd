---
title: "NSE Functions with `matrioshka`"
...
vignette: >
  %\VignetteIndexEntry{NSE Functions with matrioshka}
...
how to write programmable NSE functions with `matrioshka`.  The implementations are
...
Most of the implementation is not directly related to `matrioshka` NSE, but we will
...
The only `matrioshka` specific line is the second one:
