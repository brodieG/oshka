...
"[.super_df" <- function(x, i=NULL, j=quote(list()), by=quote(list)) {
...
While this is a little extra work, it is implemented with base R semantics, and
it is balanced by requiring less work of the user.  In particular, the user does
not need to worry about unquoting anything:
