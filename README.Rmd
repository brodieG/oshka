...
Our main objective with `recsub` was to have a simple and intuitive interface to
programmable NSE for command line users.  Simplicity however comes with limits,
and those manifest for the programmer of functions that implement NSE.  In
particular, programmers will have to ensure that expressions are evaluated in
the correct environments, as is the case with existing base R NSE functions.
...
While this is a bit of work for the author of `subset3`, it allows the users
some notable liberties:
